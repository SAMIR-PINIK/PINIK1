...
\033[1;94m ┈┈┈▕▕SAMIR-PINIK▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕B4 M4▏▏┈┈┈

\033[1;94m ┈┈┈▕▕▂╱╲▂▏▏┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈▕▕▂╱╲▂▏▏┈┈┈

\033[1;94m ┈┈┈┈╲┊┊┊┊╱┈┈┈┈\033[1;94mPINIKSAMIR.\033[1;91m┈┈┈┈╲┊┊┊┊╱┈┈┈┈

\033[1;96m ┈┈┈┈▕╲▂▂╱▏┈┈┈┈☞☞☞☞☞☞\033[1;91m☜☜☜☜☜┈┈┈┈▕╲▂▂╱▏┈┈┈┈

\033[1;96m ╱▔▔▔▔┊┊┊┊▔▔▔▔╲☞☞☞☞☞☞\033[1;91m☜☜☜☜☜╱▔▔▔▔┊┊┊┊▔▔▔▔╲

\033[1;96m................\033[1;93mPINIK-SAMIR\033[1;91m...............
...
def menu():
	...
	print (S + '[' + P + '☞2' + S + ']' + S + ' Update SAMIRPINIK_PINIK Tool')

	print (S + '[' + P + '☞3' + S + ']' + S + ' SAMIRPINIK_PINIK WhatsApp Group')
...
def mb():
	...
	if bm =='':
	    ...
	    os.system('rm -rf $HOME/SAMIRPINIK_PINIK')

	    os.system('cd $HOME && git clone https://github.com/SAMIR-PINIK/PINIK1.git')
	    ...
	    psb('Congratulations SAMIRPINIK_PINIK Tool Has Been Updated Successfully')

	    psb('🔓User Name☆ SAMIRPINIK✓')

	    psb('🔓Password ☆ PINIKSAMIR✓')

	    psb('Please Login Again')

	    time.sleep(2)

	    os.system('cd $HOME/SAMIRPINIK_PINIK && python2 Pinik.py')
